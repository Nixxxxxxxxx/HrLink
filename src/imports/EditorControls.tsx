import svgPaths from "./svg-njpa93hl3l";
...
export default function EditorControls() {
  return (
    <div className="bg-white content-stretch flex flex-col gap-[16px] items-center overflow-clip pb-[4px] pt-[12px] relative rounded-[8px] shadow-[0px_4px_16px_0px_rgba(0,0,0,0.13)] size-full" data-name="editor controls">
      <Container />
