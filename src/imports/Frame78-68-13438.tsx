import svgPaths from "./svg-vr0vgxufxo";
...
export default function Frame() {
  return (
    <div className="bg-white content-stretch flex items-center justify-between overflow-clip px-[12px] py-[8px] relative rounded-[8px] shadow-[0px_4px_16px_0px_rgba(0,0,0,0.13)] size-full">
      <Frame4 />
      <Frame5 />
    </div>
  );
