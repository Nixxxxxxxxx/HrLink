import svgPaths from "./svg-4xejx2ccn8";

function UserFilled() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="User--filled">
...
function Frame10() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[8px] items-start left-[12px] top-[12px] w-[384px]">
      <Frame5 />
      <Frame6 />
      <Frame7 />
    </div>
