import svgPaths from "./svg-7o473cqd6z";
...
export default function SidebarContainer() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start pr-[8px] pt-[8px] relative size-full" data-name="Sidebar container">
      <AudienceContainer />
      <SettingsSection />
