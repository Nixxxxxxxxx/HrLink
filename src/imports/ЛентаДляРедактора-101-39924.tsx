import svgPaths from "./svg-q8oyid4gc3";
...
function AiSpacer() {
  return (
    <div className="content-stretch flex items-start relative self-stretch shrink-0" data-name="AI spacer">
      <div className="flex h-[40px] items-center justify-center relative shrink-0 w-0" style={{ "--transform-inner-width": "1200", "--transform-inner-height": "18.875" } as React.CSSProperties}>
...
function ViewCounter1() {
  return (
    <div className="content-stretch flex items-center relative shrink-0" data-name="View counter">
      <ViewCounter2 />
    </div>
  );
}
...
function Frame13() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[27px] h-[45px] items-start left-[226px] top-[27px] w-[25px]">
...
function Frame14() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[27px] h-[45px] items-start left-[271px] top-[27px]">
...
function Frame15() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[27px] h-[45px] items-start left-[382px] top-[27px]">
...
function Frame16() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[27px] h-[45px] items-start left-[550px] top-[27px]">
...
function Frame17() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[27px] h-[45px] items-start left-[674px] top-[27px]">
...
function Navbar() {
  return (
    <div className="absolute h-[72px] left-[96px] top-[62px] w-[1416px]" data-name="navbar">
      <div className="-translate-x-1/2 absolute h-0 left-1/2 top-[72px] w-[1416px]">
        <div className="absolute inset-[-1px_0_0_0]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 1416 1">
            <line id="Line 36" stroke="var(--stroke-0, #E0E4EA)" x2="1416" y1="0.5" y2="0.5" />
          </svg>
        </div>
      </div>
      <Button7 />
