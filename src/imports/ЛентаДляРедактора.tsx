import svgPaths from "./svg-qnahw81k8g";
...
function Button() {
  return (
    <div className="absolute content-stretch flex flex-col h-[32px] items-start justify-center left-[21px] overflow-clip top-[135px] w-[151px]" data-name="Button">
...
function Frame26() {
  return (
    <div className="content-stretch flex h-[34px] items-start pl-[22px] pr-[6px] py-[8px] relative shrink-0 w-[52px]">
...
function Frame21() {
  return (
    <div className="content-stretch flex h-[34px] items-start py-[8px] relative shrink-0 w-[326px]">
      <div aria-hidden="true" className="absolute border-[#e0e4ea] border-b border-solid inset-0 pointer-events-none" />
      <p className="font-['IBM_Plex_Sans:Regular',sans-serif] leading-[18px] not-italic relative shrink-0 text-[#525252] text-[14px] tracking-[0.16px] w-[225px] whitespace-pre-wrap">Новость</p>
    </div>
  );
}
...
function Frame23() {
  return (
    <div className="content-stretch flex h-[34px] items-start px-[16px] py-[8px] relative shrink-0 w-[172px]">
      <div aria-hidden="true" className="absolute border-[#e0e4ea] border-b border-solid inset-0 pointer-events-none" />
      <p className="font-['IBM_Plex_Sans:Regular',sans-serif] leading-[18px] not-italic relative shrink-0 text-[#525252] text-[14px] tracking-[0.16px]">Рубрика</p>
    </div>
  );
}
...
function Frame22() {
  return (
    <div className="content-stretch flex h-[34px] items-start py-[8px] relative shrink-0 w-[255px]">
      <div aria-hidden="true" className="absolute border-[#e0e4ea] border-b border-solid inset-0 pointer-events-none" />
      <p className="font-['IBM_Plex_Sans:Regular',sans-serif] leading-[18px] not-italic relative shrink-0 text-[#525252] text-[14px] tracking-[0.16px] w-[226px] whitespace-pre-wrap">Таргет</p>
    </div>
  );
}
...
function Frame24() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col h-[34px] items-start min-h-px min-w-px py-[8px] relative">
      <div aria-hidden="true" className="absolute border-[#e0e4ea] border-b border-solid inset-0 pointer-events-none" />
      <p className="font-['IBM_Plex_Sans:Regular',sans-serif] leading-[18px] not-italic relative shrink-0 text-[#525252] text-[14px] tracking-[0.16px]">Статус</p>
    </div>
  );
}
...
function Frame25() {
  return (
    <div className="content-stretch flex h-[34px] items-start py-[8px] relative shrink-0 w-[136px]">
      <div aria-hidden="true" className="absolute border-[#e0e4ea] border-b border-solid inset-0 pointer-events-none" />
      <p className="font-['IBM_Plex_Sans:Regular',sans-serif] leading-[18px] not-italic relative shrink-0 text-[#525252] text-[14px] tracking-[0.16px]">Дата публикации</p>
    </div>
  );
}
...
function Label() {
  return (
    <div className="content-stretch flex flex-col items-center mr-[-4px] pb-[2px] px-[8px] relative shrink-0" data-name="Label">
      <p className="font-['IBM_Plex_Sans:Regular',sans-serif] leading-[16px] not-italic relative shrink-0 text-[#0043ce] text-[12px] tracking-[0.32px]">Закреплена до 12.02.2026</p>
      <Resizer />
    </div>
  );
}
...
function Frame37() {
  return (
    <div className="content-stretch flex h-[96px] items-start justify-center pl-[18px] pr-[6px] py-[8px] relative shrink-0 w-[52px]">
      <div aria-hidden="true" className="absolute border-[#e0e4ea] border-b border-solid inset-0 pointer-events-none" />
      <Checkbox4 />
    </div>
  );
...
function Frame40() {
  return (
    <div className="content-stretch flex gap-[6px] items-center relative shrink-0">
      <View1 />
      <p className="font-['IBM_Plex_Sans:Regular',sans-serif] leading-[18px] not-italic relative shrink-0 text-[#525252] text-[14px] tracking-[0.16px]">563 из 24K</p>
    </div>
  );
}
...
function Frame39() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[8px] items-start min-h-px min-w-px relative">
      <p className="font-['IBM_Plex_Sans:Regular',sans-serif] leading-[18px] not-italic relative shrink-0 text-[#161616] text-[14px] tracking-[0.16px] w-[197px] whitespace-pre-wrap">Обновление системы учета рабочего времени: преимущества и недостатки</p>
      <Frame40 />
    </div>
  );
}
...
function Frame38() {
  return (
    <div className="content-stretch flex gap-[16px] items-start py-[8px] relative shrink-0 w-[326px]">
      <div aria-hidden="true" className="absolute border-[#e0e4ea] border-b border-solid inset-0 pointer-events-none" />
      <div className="bg-[#d9d9d9] h-[38px] shrink-0 w-[48px]" />
      <Frame39 />
      <Fire />
...
function Frame41() {
  return (
    <div className="content-stretch flex h-[96px] items-start px-[16px] py-[8px] relative shrink-0 w-[172px]">
      <div aria-hidden="true" className="absolute border-[#e0e4ea] border-b border-solid inset-0 pointer-events-none" />
      <p className="font-['IBM_Plex_Sans:Regular',sans-serif] leading-[18px] not-italic relative shrink-0 text-[#161616] text-[14px] tracking-[0.16px]">HR</p>
    </div>
  );
}
...
function Frame42() {
  return (
    <div className="content-stretch flex h-[96px] items-start py-[8px] relative shrink-0 w-[255px]">
      <div aria-hidden="true" className="absolute border-[#e0e4ea] border-b border-solid inset-0 pointer-events-none" />
      <p className="font-['IBM_Plex_Sans:Regular',sans-serif] leading-[18px] not-italic relative shrink-0 text-[#161616] text-[14px] tracking-[0.16px] w-[226px] whitespace-pre-wrap">Сотрудники, молодое поколение, эффективность, технологии</p>
    </div>
  );
}
...
function Label2() {
  return (
    <div className="content-stretch flex flex-col items-center mr-[-4px] pb-[2px] px-[8px] relative shrink-0" data-name="Label">
      <p className="font-['IBM_Plex_Sans:Regular',sans-serif] leading-[16px] not-italic relative shrink-0 text-[#6929c4] text-[12px] tracking-[0.32px]">На согласовании</p>
      <Resizer2 />
    </div>
  );
}
...
function TagReadOnly2() {
  return (
    <div className="bg-[#e8daff] content-stretch flex items-start pr-[6px] relative rounded-[12px] shrink-0" data-name="Tag - Read-only">
      <TagContent2 />
    </div>
  );
}
...
function Frame43() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col h-[96px] items-start min-h-px min-w-px py-[8px] relative">
      <div aria-hidden="true" className="absolute border-[#e0e4ea] border-b border-solid inset-0 pointer-events-none" />
      <TagReadOnly2 />
    </div>
  );
...
function Frame44() {
  return (
    <div className="content-stretch flex h-[96px] items-start py-[8px] relative shrink-0 w-[136px]">
      <div aria-hidden="true" className="absolute border-[#e0e4ea] border-b border-solid inset-0 pointer-events-none" />
      <p className="font-['IBM_Plex_Sans:Regular',sans-serif] leading-[18px] not-italic relative shrink-0 text-[#161616] text-[14px] tracking-[0.16px]">16.05.2024</p>
    </div>
  );
}
...
function Frame49() {
  return (
    <div className="content-stretch flex gap-[6px] items-center relative shrink-0">
      <View2 />
      <p className="font-['IBM_Plex_Sans:Regular',sans-serif] leading-[18px] not-italic relative shrink-0 text-[#525252] text-[14px] tracking-[0.16px]">720 из 13K</p>
    </div>
  );
}
...
function Frame48() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 w-[223px]">
      <p className="font-['IBM_Plex_Sans:Regular',sans-serif] leading-[18px] not-italic relative shrink-0 text-[#161616] text-[14px] tracking-[0.16px] w-[225px] whitespace-pre-wrap">Внедрение новых технологий в производственный процесс: что нужно знать</p>
      <Frame49 />
    </div>
  );
}
...
function Frame50() {
  return (
    <div className="content-stretch flex h-[96px] items-start px-[16px] py-[8px] relative shrink-0 w-[172px]">
      <div aria-hidden="true" className="absolute border-[#e0e4ea] border-b border-solid inset-0 pointer-events-none" />
      <p className="flex-[1_0_0] font-['IBM_Plex_Sans:Regular',sans-serif] leading-[18px] min-h-px min-w-px not-italic relative text-[#161616] text-[14px] tracking-[0.16px] whitespace-pre-wrap">Производственный отдел</p>
    </div>
  );
}
...
function Frame51() {
  return (
    <div className="content-stretch flex h-[96px] items-start py-[8px] relative shrink-0 w-[255px]">
      <div aria-hidden="true" className="absolute border-[#e0e4ea] border-b border-solid inset-0 pointer-events-none" />
      <p className="font-['IBM_Plex_Sans:Regular',sans-serif] leading-[18px] not-italic relative shrink-0 text-[#161616] text-[14px] tracking-[0.16px] w-[226px] whitespace-pre-wrap">Инженеры, менеджеры проектов, инновации, развитие</p>
    </div>
  );
}
...
function Frame53() {
  return (
    <div className="content-stretch flex h-[96px] items-start py-[8px] relative shrink-0 w-[136px]">
      <div aria-hidden="true" className="absolute border-[#e0e4ea] border-b border-solid inset-0 pointer-events-none" />
      <p className="font-['IBM_Plex_Sans:Regular',sans-serif] leading-[18px] not-italic relative shrink-0 text-[#161616] text-[14px] tracking-[0.16px]">16.05.2025</p>
    </div>
  );
}
...
function Frame60() {
  return (
    <div className="content-stretch flex h-[96px] items-start py-[8px] relative shrink-0 w-[255px]">
      <div aria-hidden="true" className="absolute border-[#e0e4ea] border-b border-solid inset-0 pointer-events-none" />
      <p className="font-['IBM_Plex_Sans:Regular',sans-serif] leading-[18px] not-italic relative shrink-0 text-[#161616] text-[14px] tracking-[0.16px] w-[226px] whitespace-pre-wrap">Сотрудники всех уровней, зарплата, мотивация</p>
    </div>
  );
}
...
function Label4() {
  return (
    <div className="content-stretch flex flex-col items-center mr-[-4px] pb-[2px] px-[8px] relative shrink-0" data-name="Label">
      <p className="font-['IBM_Plex_Sans:Regular',sans-serif] leading-[16px] not-italic relative shrink-0 text-[#0e6027] text-[12px] tracking-[0.32px]">Запланировано</p>
      <Resizer4 />
    </div>
  );
}
...
function Frame62() {
  return (
    <div className="content-stretch flex h-[96px] items-start py-[8px] relative shrink-0 w-[136px]">
      <div aria-hidden="true" className="absolute border-[#e0e4ea] border-b border-solid inset-0 pointer-events-none" />
      <p className="font-['IBM_Plex_Sans:Regular',sans-serif] leading-[18px] not-italic relative shrink-0 text-[#161616] text-[14px] tracking-[0.16px]">18.05.2024</p>
    </div>
  );
}
...
function Frame67() {
  return (
    <div className="content-stretch flex gap-[6px] items-center relative shrink-0">
      <View4 />
      <p className="font-['IBM_Plex_Sans:Regular',sans-serif] leading-[18px] not-italic relative shrink-0 text-[#525252] text-[14px] tracking-[0.16px]">1020 из 2K</p>
    </div>
  );
}
...
function Frame66() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 w-[223px]">
      <p className="font-['IBM_Plex_Sans:Regular',sans-serif] leading-[18px] not-italic relative shrink-0 text-[#161616] text-[14px] tracking-[0.16px] w-[225px] whitespace-pre-wrap">Новая стратегия маркетинга: направления и фокус</p>
      <Frame67 />
    </div>
  );
}
...
function Frame65() {
  return (
    <div className="content-stretch flex gap-[16px] h-[96px] items-start py-[8px] relative shrink-0 w-[326px]">
      <div aria-hidden="true" className="absolute border-[#e0e4ea] border-b border-solid inset-0 pointer-events-none" />
      <div className="bg-[#d9d9d9] h-[38px] shrink-0 w-[48px]" />
      <Frame66 />
    </div>
...
function Frame68() {
  return (
    <div className="content-stretch flex h-[96px] items-start px-[16px] py-[8px] relative shrink-0 w-[172px]">
      <div aria-hidden="true" className="absolute border-[#e0e4ea] border-b border-solid inset-0 pointer-events-none" />
      <p className="font-['IBM_Plex_Sans:Regular',sans-serif] leading-[18px] not-italic relative shrink-0 text-[#161616] text-[14px] tracking-[0.16px]">Маркетинг</p>
    </div>
  );
}
...
function Frame69() {
  return (
    <div className="content-stretch flex h-[96px] items-start py-[8px] relative shrink-0 w-[255px]">
      <div aria-hidden="true" className="absolute border-[#e0e4ea] border-b border-solid inset-0 pointer-events-none" />
      <p className="font-['IBM_Plex_Sans:Regular',sans-serif] leading-[18px] not-italic relative shrink-0 text-[#161616] text-[14px] tracking-[0.16px] w-[226px] whitespace-pre-wrap">Маркетологи, креативные специалисты, реклама, тренды</p>
    </div>
  );
}
...
function Frame71() {
  return (
    <div className="content-stretch flex h-[96px] items-start py-[8px] relative shrink-0 w-[136px]">
      <div aria-hidden="true" className="absolute border-[#e0e4ea] border-b border-solid inset-0 pointer-events-none" />
      <p className="font-['IBM_Plex_Sans:Regular',sans-serif] leading-[18px] not-italic relative shrink-0 text-[#161616] text-[14px] tracking-[0.16px]">19.05.2024</p>
    </div>
  );
}
...
function Frame76() {
  return (
    <div className="content-stretch flex gap-[8px] items-start relative shrink-0 w-full">
      <p className="font-['IBM_Plex_Sans:Regular',sans-serif] leading-[18px] not-italic relative shrink-0 text-[#161616] text-[14px] tracking-[0.16px] w-[227px] whitespace-pre-wrap">Обучение сотрудников стратегіям управления временем</p>
      <Fire2 />
    </div>
  );
}
...
function Frame77() {
  return (
    <div className="content-stretch flex gap-[6px] items-center relative shrink-0">
      <View5 />
      <p className="font-['IBM_Plex_Sans:Regular',sans-serif] leading-[18px] not-italic relative shrink-0 text-[#525252] text-[14px] tracking-[0.16px]">675 из 1K</p>
    </div>
  );
}
...
function Frame79() {
  return (
    <div className="content-stretch flex h-[96px] items-start py-[8px] relative shrink-0 w-[255px]">
      <div aria-hidden="true" className="absolute border-[#e0e4ea] border-b border-solid inset-0 pointer-events-none" />
      <p className="font-['IBM_Plex_Sans:Regular',sans-serif] leading-[18px] not-italic relative shrink-0 text-[#161616] text-[14px] tracking-[0.16px] w-[226px] whitespace-pre-wrap">Сторонники обучения, развитие, личная эффективность</p>
    </div>
  );
}
...
function Frame81() {
  return (
    <div className="content-stretch flex h-[96px] items-start py-[8px] relative shrink-0 w-[136px]">
      <div aria-hidden="true" className="absolute border-[#e0e4ea] border-b border-solid inset-0 pointer-events-none" />
      <p className="font-['IBM_Plex_Sans:Regular',sans-serif] leading-[18px] not-italic relative shrink-0 text-[#161616] text-[14px] tracking-[0.16px]">20.05.2024</p>
    </div>
  );
}
...
function Frame86() {
  return (
    <div className="content-stretch flex gap-[6px] items-center relative shrink-0">
      <View6 />
      <p className="font-['IBM_Plex_Sans:Regular',sans-serif] leading-[18px] not-italic relative shrink-0 text-[#525252] text-[14px] tracking-[0.16px]">830 из 15K</p>
    </div>
  );
}
...
function Frame85() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 w-[223px]">
      <p className="font-['IBM_Plex_Sans:Regular',sans-serif] leading-[18px] not-italic relative shrink-0 text-[#161616] text-[14px] tracking-[0.16px] w-[225px] whitespace-pre-wrap">Новые требования к экологической ответственности компании</p>
      <Frame86 />
    </div>
  );
}
...
function Frame87() {
  return (
    <div className="content-stretch flex h-[96px] items-start px-[16px] py-[8px] relative shrink-0 w-[172px]">
      <div aria-hidden="true" className="absolute border-[#e0e4ea] border-b border-solid inset-0 pointer-events-none" />
      <p className="font-['IBM_Plex_Sans:Regular',sans-serif] leading-[18px] not-italic relative shrink-0 text-[#161616] text-[14px] tracking-[0.16px]">Управление</p>
    </div>
  );
}
...
function Frame88() {
  return (
    <div className="content-stretch flex h-[96px] items-start py-[8px] relative shrink-0 w-[255px]">
      <div aria-hidden="true" className="absolute border-[#e0e4ea] border-b border-solid inset-0 pointer-events-none" />
      <p className="font-['IBM_Plex_Sans:Regular',sans-serif] leading-[18px] not-italic relative shrink-0 text-[#161616] text-[14px] tracking-[0.16px] w-[226px] whitespace-pre-wrap">Руководство, устойчивое развитие, экология</p>
    </div>
  );
}
...
function Frame90() {
  return (
    <div className="content-stretch flex h-[96px] items-start py-[8px] relative shrink-0 w-[136px]">
      <div aria-hidden="true" className="absolute border-[#e0e4ea] border-b border-solid inset-0 pointer-events-none" />
      <p className="font-['IBM_Plex_Sans:Regular',sans-serif] leading-[18px] not-italic relative shrink-0 text-[#161616] text-[14px] tracking-[0.16px]">21.05.2024</p>
    </div>
  );
}
...
function Frame30() {
  return (
    <div className="absolute content-stretch flex flex-col items-start left-[232px] top-[8px] w-[1147px]">
      <Frame29 />
      <Frame28 />
      <Frame36 />
      <Frame45 />
  ...
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Caret--left">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="Caret--left">
          <rect fill="white" fillOpacity="0.01" height="16" style={{ mixBlendMode: "multiply" }} width="16" />
          <path d="M10 12L5 8L10 4V12Z" fill="var(--fill-0, #161616)" fillOpacity="0.25" id="Vector" />
        </g>
      </svg>
    </div>
  );
...
function PaginationTrigger() {
  return (
    <div className="content-stretch flex flex-col items-center justify-center relative shrink-0 size-[48px]" data-name="Pagination trigger">
      <div className="flex flex-[1_0_0] flex-col font-['IBM_Plex_Sans:Bold',sans-serif] justify-center leading-[0] min-h-px min-w-px not-italic relative text-[#161616] text-[14px] text-center tracking-[0.16px] w-full">
        <p className="leading-[18px] whitespace-pre-wrap">1</p>
      </div>
      <div className="h-0 relative shrink-0 w-[16px]" data-name="Border">
        <div className="absolute inset-[-4px_0_0_0]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 4">
            <line id="Border" stroke="var(--stroke-0, #0F62FE)" strokeWidth="4" x2="16" y1="2" y2="2" />
          </svg>
        </div>
      </div>
    </div>
...
function PaginationNavPageItem() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0" data-name="_Pagination - Nav page item">
      <div aria-hidden="true" className="absolute bg-[rgba(255,255,255,0)] inset-0 mix-blend-multiply pointer-events-none" />
      <PaginationTrigger />
    </div>
  );
...
function PaginationTrigger1() {
  return (
    <div className="content-stretch flex flex-col items-center justify-center relative shrink-0 size-[48px]" data-name="Pagination trigger">
      <div className="flex flex-[1_0_0] flex-col font-['IBM_Plex_Sans:Regular',sans-serif] justify-center leading-[0] min-h-px min-w-px not-italic relative text-[#161616] text-[14px] text-center tracking-[0.16px] w-full">
        <p className="leading-[18px] whitespace-pre-wrap">2</p>
      </div>
    </div>
  );
}

function PaginationNavPageItem1() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0" data-name="_Pagination - Nav page item">
      <div aria-hidden="true" className="absolute bg-[rgba(255,255,255,0)] inset-0 mix-blend-multiply pointer-events-none" />
      <PaginationTrigger1 />
...
function PaginationNavPageItem2() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0" data-name="_Pagination - Nav page item">
      <div aria-hidden="true" className="absolute bg-[rgba(255,255,255,0)] inset-0 mix-blend-multiply pointer-events-none" />
      <PaginationTrigger2 />
...
function PaginationTrigger3() {
  return (
    <div className="content-stretch flex flex-col items-center justify-center relative shrink-0 size-[48px]" data-name="Pagination trigger">
      <div className="flex flex-[1_0_0] flex-col font-['IBM_Plex_Sans:Regular',sans-serif] justify-center leading-[0] min-h-px min-w-px not-italic relative text-[#161616] text-[14px] text-center tracking-[0.16px] w-full">
        <p className="leading-[18px] whitespace-pre-wrap">4</p>
      </div>
    </div>
  );
}

function PaginationNavPageItem3() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0" data-name="_Pagination - Nav page item">
      <div aria-hidden="true" className="absolute bg-[rgba(255,255,255,0)] inset-0 mix-blend-multiply pointer-events-none" />
      <PaginationTrigger3 />
...
function PaginationTrigger4() {
  return (
    <div className="content-stretch flex flex-col items-center justify-center relative shrink-0 size-[48px]" data-name="Pagination trigger">
      <div className="flex flex-[1_0_0] flex-col font-['IBM_Plex_Sans:Regular',sans-serif] justify-center leading-[0] min-h-px min-w-px not-italic relative text-[#161616] text-[14px] text-center tracking-[0.16px] w-full">
        <p className="leading-[18px] whitespace-pre-wrap">5</p>
      </div>
    </div>
  );
}

function PaginationNavPageItem4() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0" data-name="_Pagination - Nav page item">
      <div aria-hidden="true" className="absolute bg-[rgba(255,255,255,0)] inset-0 mix-blend-multiply pointer-events-none" />
      <PaginationTrigger4 />
...
function PaginationNavPageItem5() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0" data-name="_Pagination - Nav page item">
      <div aria-hidden="true" className="absolute bg-[rgba(255,255,255,0)] inset-0 mix-blend-multiply pointer-events-none" />
      <PaginationTrigger5 />
...
function PaginationTrigger6() {
  return (
    <div className="content-stretch flex flex-col items-center justify-center relative shrink-0 size-[48px]" data-name="Pagination trigger">
      <div className="flex flex-[1_0_0] flex-col font-['IBM_Plex_Sans:Regular',sans-serif] justify-center leading-[0] min-h-px min-w-px not-italic relative text-[#161616] text-[14px] text-center tracking-[0.16px] w-full">
        <p className="leading-[18px] whitespace-pre-wrap">30</p>
      </div>
    </div>
  );
}

function PaginationNavPageItem6() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0" data-name="_Pagination - Nav page item">
      <div aria-hidden="true" className="absolute bg-[rgba(255,255,255,0)] inset-0 mix-blend-multiply pointer-events-none" />
      <PaginationTrigger6 />
...
function PaginationNav() {
  return (
    <div className="absolute content-stretch flex items-start left-[232px] top-[722px] w-[432px]" data-name="Pagination - Nav">
      <Button1 />
      <PaginationNavPageItem />
      <PaginationNavPageItem1 />
      <PaginationNavPageItem2 />
      <PaginationNavPageItem3 />
      <PaginationNavPageItem4 />
      <PaginationNavPageItem5 />
      <PaginationNavPageItem6 />
      <Button2 />
    </div>
  );
}
...
function Frame9() {
  return (
    <div className="absolute bg-white h-[826px] left-[109px] overflow-clip top-[138px] w-[1379px]">
      <p className="absolute font-['IBM_Plex_Sans:Regular',sans-serif] leading-[18px] left-[21px] not-italic text-[#525252] text-[14px] top-[105px] tracking-[0.16px]">3 квартал 2026</p>
      <p className="absolute font-['IBM_Plex_Sans:Regular',sans-serif] leading-[18px] left-[21px] not-italic text-[#525252] text-[14px] top-[76px] tracking-[0.16px]">Для важных новостей</p>
      <p className="absolute font-['IBM_Plex_Sans:SemiBold',sans-serif] leading-[18px] left-[21px] not-italic text-[#161616] text-[14px] top-[25px] tracking-[0.16px]">Все новости</p>
      <p className="absolute font-['IBM_Plex_Sans:Regular',sans-serif] leading-[18px] left-[21px] not-italic text-[#525252] text-[14px] top-[51px] tracking-[0.16px]">Контент план</p>
      <Button />
      <div className="absolute flex h-[826px] items-center justify-center left-[232px] top-0 w-0" style={{ "--transform-inner-width": "1200", "--transform-inner-height": "18.875" } as React.CSSProperties}>
        <div className="flex-none rotate-90">
          <div className="h-0 relative w-[826px]">
            <div className="absolute inset-[-1px_0_0_0]">
              <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 826 1">
                <line id="Line 33" opacity="0.2" stroke="var(--stroke-0, black)" x2="826" y1="0.5" y2="0.5" />
              </svg>
            </div>
          </div>
        </div>
...
function UiShellLeftPanelGroupSideRail() {
  return (
    <div className="absolute bg-white h-[918px] left-0 top-[64px] w-[96px]" data-name="ui shell / left panel / group / side rail">
      ...
      <div className="absolute inset-[-5%_-2.78%_-5%_0]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 37 22">
          <g id="Switch">
            ...
            <g filter="url(#filter0_d_48_11260)" id="ð¨ Color l Thumb">
              <path clipRule="evenodd" d={svgPaths.p1fd353c0} fill="var(--fill-0, #054ADA)" fillRule="evenodd" />
            </g>
          </g>
          <defs>
            <filter colorInterpolationFilters="sRGB" filterUnits="userSpaceOnUse" height="22" id="filter0_d_48_11260" width="22" x="15" y="0">
              ...
              <feBlend in2="BackgroundImageFix" mode="normal" result="effect1_dropShadow_48_11260" />
              <feBlend in="SourceGraphic" in2="effect1_dropShadow_48_11260" mode="normal" result="shape" />
            </filter>
          </defs>
        </svg>
      </div>
...
function Frame10() {
  return (
    <div className="absolute content-stretch flex gap-[8px] items-center left-[472px] top-[93px]">
      <p className="font-['IBM_Plex_Sans:Regular',sans-serif] leading-[18px] not-italic overflow-hidden relative shrink-0 text-[#161616] text-[14px] text-ellipsis tracking-[0.16px]">Все рубрики</p>
      <DropdownChevron />
    </div>
  );
}
...
function Frame11() {
  return (
    <div className="absolute content-stretch flex gap-[8px] items-center left-[345px] top-[93px]">
      <p className="font-['IBM_Plex_Sans:Regular',sans-serif] leading-[18px] not-italic overflow-hidden relative shrink-0 text-[#161616] text-[14px] text-ellipsis tracking-[0.16px]">Все таргеты</p>
      <DropdownChevron1 />
    </div>
  );
}
...
function Frame12() {
  return (
    <div className="absolute content-stretch flex gap-[8px] items-center left-[718px] top-[93px]">
      <p className="font-['IBM_Plex_Sans:Regular',sans-serif] leading-[18px] not-italic overflow-hidden relative shrink-0 text-[#161616] text-[14px] text-ellipsis tracking-[0.16px]">Все авторы</p>
      <DropdownChevron2 />
    </div>
  );
}
...
function Frame14() {
  return (
    <div className="absolute content-stretch flex gap-[8px] items-center left-[596px] top-[93px]">
      <p className="font-['IBM_Plex_Sans:Regular',sans-serif] leading-[18px] not-italic overflow-hidden relative shrink-0 text-[#161616] text-[14px] text-ellipsis tracking-[0.16px]">Все статусы</p>
      <DropdownChevron3 />
    </div>
  );
}
...
function Frame13() {
  return (
    <div className="absolute content-stretch flex gap-[8px] items-center left-[841px] top-[93px]">
      <p className="font-['IBM_Plex_Sans:Regular',sans-serif] leading-[18px] not-italic overflow-hidden relative shrink-0 text-[#161616] text-[14px] text-ellipsis tracking-[0.16px]">За все время</p>
      <DropdownChevron4 />
    </div>
  );
}
...
function HideTextOverflow() {
  return (
    <div className="content-stretch flex flex-[1_0_0] h-[18px] items-start min-h-px min-w-px overflow-clip relative" data-name="Hide text overflow">
      <p className="flex-[1_0_0] font-['IBM_Plex_Sans:Regular',sans-serif] h-[18px] leading-[18px] min-h-px min-w-px not-italic relative text-[#a8a8a8] text-[14px] tracking-[0.16px] whitespace-pre-wrap">Поиск по новостям</p>
    </div>
  );
}
...
function SearchDefault() {
  return (
    <div className="absolute bg-white content-stretch flex items-center left-[109px] top-[82px] w-[212px]" data-name="Search - Default">
...
function Checkbox16() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[8px] items-start left-[975px] top-[92px]" data-name="Checkbox">
      <div aria-hidden="true" className="absolute bg-[rgba(255,255,255,0)] inset-0 mix-blend-multiply pointer-events-none" />
      <IconValue8 />
    </div>
  );
...
function Button3() {
  return (
    <div className="absolute bg-[#393939] content-stretch flex flex-col h-[40px] items-start justify-center left-[1293px] overflow-clip top-[82px] w-[152px]" data-name="Button">
      <ButtonContent3 />
    </div>
  );
}
...
function Button4() {
  return (
    <div className="absolute bg-[#393939] content-stretch flex flex-col items-start justify-center left-[1447px] overflow-clip size-[40px] top-[82px]" data-name="Button">
      <ButtonContent4 />
    </div>
  );
}
...
export default function Component() {
  return (
    <div className="bg-[#f2f4f8] relative size-full" data-name="Лента для редактора">
      <Frame9 />
