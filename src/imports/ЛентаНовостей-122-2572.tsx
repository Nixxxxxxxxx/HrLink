import svgPaths from "./svg-75fx77y7li";
...
function Img() {
  return (
    <div className="h-[106px] relative shrink-0 w-full" data-name="Img">
      <div className="-translate-x-1/2 -translate-y-1/2 absolute flex h-[86.297px] items-center justify-center left-[calc(50%-38.36px)] top-[calc(50%-3.39px)] w-[110.537px]" style={{ "--transform-inner-width": "1200", "--transform-inner-height": "18.875" } as React.CSSProperties}>
      ...
      <div className="-translate-x-1/2 -translate-y-1/2 absolute flex h-[67.728px] items-center justify-center left-[calc(50%+41px)] top-[calc(50%+2.45px)] w-[85.257px]" style={{ "--transform-inner-width": "1200", "--transform-inner-height": "18.875" } as React.CSSProperties}>
