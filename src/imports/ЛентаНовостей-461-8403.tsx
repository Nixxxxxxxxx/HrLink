import svgPaths from "./svg-k2xdxyt9le";
...
import imgEllipse35 from "figma:asset/29fe03a5fda5378cea559404953aed46264597fc.png";
import imgEllipse36 from "figma:asset/16718e4d2dc9e3c91484a9879830bc5f2fa215ca.png";
import imgEllipse37 from "figma:asset/182b5f1324793de09e45b39fa4dd97f4f4de551e.png";
import imgEllipse38 from "figma:asset/6831aa67e63c28c998ca4eaa0e8c1837e398cf82.png";
import imgEllipse39 from "figma:asset/f4a1c3f92dd8e9b5a03d477f0c5f1221975f1d4f.png";
import imgEllipse40 from "figma:asset/dea5a22192171381fe6f756a1237f654fdcae512.png";
...
function HrlinkLogo() {
  return (
    <div className="absolute inset-[0.25%_0_2%_0.05%]" data-name="hrlink_logo">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 62.0843 23.4593">
        <g id="hrlink_logo">
        ...
        <div className="absolute bottom-0 right-0 top-0 w-[20px]" data-name="🎨 Color l Thumb">
          <div className="absolute inset-[-5%]">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 22 22">
              <g filter="url(#filter0_d_461_12776)" id="ð¨ Color l Thumb">
                <path clipRule="evenodd" d={svgPaths.pb60700} fill="var(--fill-0, #054ADA)" fillRule="evenodd" />
              </g>
              <defs>
                <filter colorInterpolationFilters="sRGB" filterUnits="userSpaceOnUse" height="22" id="filter0_d_461_12776" width="22" x="0" y="0">
                  ...
                  <feBlend in2="BackgroundImageFix" mode="normal" result="effect1_dropShadow_461_12776" />
                  <feBlend in="SourceGraphic" in2="effect1_dropShadow_461_12776" mode="normal" result="shape" />
                </filter>
              </defs>
            </svg>
          </div>
...
function Pagination() {
  return (
    <div className="-translate-x-1/2 absolute h-[8px] left-[calc(50%-0.5px)] top-[821px] w-[88px]" data-name="Pagination">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 88 8">
        <g id="Pagination">
          <circle cx="4" cy="4" fill="var(--fill-0, #E3E5E8)" fillOpacity="0.3" id="Ellipse 37" r="4" />
          <circle cx="24" cy="4" fill="var(--fill-0, white)" id="Ellipse 38" r="4" />
...
function EmployeeInfo() {
  return (
    <div className="content-stretch flex flex-col font-['IBM_Plex_Sans:Regular',sans-serif] items-start leading-[20px] not-italic relative shrink-0 text-[14px] text-ellipsis tracking-[0.16px] w-[112px] whitespace-pre-wrap" data-name="Employee info">
      <p className="overflow-hidden relative shrink-0 text-white w-full">Анна симоновна</p>
      <p className="overflow-hidden relative shrink-0 text-[rgba(255,255,255,0.6)] w-full">Дизайнер</p>
    </div>
  );
}
...
function NewsItem() {
  return (
    <div className="content-stretch flex gap-[12px] items-center relative shrink-0 w-full" data-name="News item">
      <div className="relative shrink-0 size-[40px]">
        <img alt="" className="absolute block max-w-none size-full" height="40" src={imgEllipse35} width="40" />
      </div>
      <EmployeeInfo />
    </div>
  );
...
function EmployeeInfo1() {
  return (
    <div className="content-stretch flex flex-col font-['IBM_Plex_Sans:Regular',sans-serif] items-start leading-[20px] not-italic relative shrink-0 text-[14px] text-ellipsis tracking-[0.16px] w-[310px]" data-name="Employee info">
      <p className="overflow-hidden relative shrink-0 text-white">Алена Константиновна</p>
      <p className="overflow-hidden relative shrink-0 text-[rgba(255,255,255,0.6)]">Продуктовый дизайнер</p>
    </div>
  );
}
...
function NewsItem1() {
  return (
    <div className="content-stretch flex gap-[12px] items-center relative shrink-0 w-full" data-name="News item">
      <div className="relative shrink-0 size-[40px]">
        <img alt="" className="absolute block max-w-none size-full" height="40" src={imgEllipse36} width="40" />
      </div>
      <EmployeeInfo1 />
    </div>
  );
...
function EmployeeInfo2() {
  return (
    <div className="content-stretch flex flex-col font-['IBM_Plex_Sans:Regular',sans-serif] items-start leading-[20px] not-italic relative shrink-0 text-[14px] text-ellipsis tracking-[0.16px] w-[310px]" data-name="Employee info">
      <p className="overflow-hidden relative shrink-0 text-white">Сергей Петрович</p>
      <p className="overflow-hidden relative shrink-0 text-[rgba(255,255,255,0.6)]">Графический дизайнер</p>
    </div>
  );
}
...
function NewsItem2() {
  return (
    <div className="content-stretch flex gap-[12px] items-center relative shrink-0 w-full" data-name="News item">
      <div className="relative shrink-0 size-[40px]">
        <img alt="" className="absolute block max-w-none size-full" height="40" src={imgEllipse37} width="40" />
      </div>
      <EmployeeInfo2 />
    </div>
  );
...
function EmployeeInfo3() {
  return (
    <div className="content-stretch flex flex-col font-['IBM_Plex_Sans:Regular',sans-serif] items-start leading-[20px] not-italic relative shrink-0 text-[14px] text-ellipsis tracking-[0.16px] w-[310px]" data-name="Employee info">
      <p className="overflow-hidden relative shrink-0 text-white">Мария Ивановна</p>
      <p className="overflow-hidden relative shrink-0 text-[rgba(255,255,255,0.6)]">UX/UI дизайнер</p>
    </div>
  );
}
...
function NewsItem3() {
  return (
    <div className="content-stretch flex gap-[12px] items-center relative shrink-0 w-full" data-name="News item">
      <div className="relative shrink-0 size-[40px]">
        <img alt="" className="absolute block max-w-none size-full" height="40" src={imgEllipse38} width="40" />
      </div>
      <EmployeeInfo3 />
    </div>
  );
...
function EmployeeInfo4() {
  return (
    <div className="content-stretch flex flex-col font-['IBM_Plex_Sans:Regular',sans-serif] items-start leading-[20px] not-italic relative shrink-0 text-[14px] text-ellipsis tracking-[0.16px] w-[310px]" data-name="Employee info">
      <p className="overflow-hidden relative shrink-0 text-white">Дмитрий Александрович</p>
      <p className="overflow-hidden relative shrink-0 text-[rgba(255,255,255,0.6)]">Арт-директор</p>
    </div>
  );
}
...
function NewsItem4() {
  return (
    <div className="content-stretch flex gap-[12px] items-center relative shrink-0 w-full" data-name="News item">
      <div className="relative shrink-0 size-[40px]">
        <img alt="" className="absolute block max-w-none size-full" height="40" src={imgEllipse39} width="40" />
      </div>
      <EmployeeInfo4 />
    </div>
  );
...
function EmployeeInfo5() {
  return (
    <div className="content-stretch flex flex-col font-['IBM_Plex_Sans:Regular',sans-serif] items-start leading-[20px] not-italic relative shrink-0 text-[14px] text-ellipsis tracking-[0.16px] w-[310px]" data-name="Employee info">
      <p className="overflow-hidden relative shrink-0 text-white">Екатерина Викторовна</p>
      <p className="overflow-hidden relative shrink-0 text-[rgba(255,255,255,0.6)]">Исследователь пользовательского...</p>
    </div>
  );
}
...
function NewsItem5() {
  return (
    <div className="content-stretch flex gap-[12px] items-center relative shrink-0 w-full" data-name="News item">
      <div className="relative shrink-0 size-[40px]">
        <img alt="" className="absolute block max-w-none size-full" height="40" src={imgEllipse40} width="40" />
      </div>
      <EmployeeInfo5 />
    </div>
  );
...
function NewsList() {
  return (
    <div className="absolute bg-[rgba(171,192,255,0.1)] content-stretch flex flex-col gap-[12px] items-start left-[24px] p-[16px] rounded-[12px] top-[202px] w-[439px]" data-name="News list">
      <NewsItem />
      <NewsItem1 />
      <NewsItem2 />
      <NewsItem3 />
...
function ActionItem() {
  return (
    <div className="content-stretch flex gap-[12px] items-center relative shrink-0 w-full" data-name="Action item">
      <div className="relative shrink-0 size-[40px]">
        <img alt="" className="absolute block max-w-none size-full" height="40" src={imgEllipse35} width="40" />
      </div>
      <EmployeeInfo6 />
...
function ActionList() {
  return (
    <div className="absolute bg-[rgba(171,192,255,0.1)] content-stretch flex flex-col gap-[12px] items-start left-[24px] p-[16px] rounded-[12px] top-[585px] w-[439px]" data-name="Action list">
      <ActionItem />
      <ActionItem1 />
    </div>
  );
...
function Component1() {
  return (
    <div className="absolute bg-[#1b1f29] h-[853px] left-[calc(37.5%-8px)] overflow-clip rounded-[12px] top-[65px] w-[487px]" data-name="Сотрудник">
      <div className="absolute h-[462px] left-[-208px] top-[717px] w-[816px]">
        <div className="absolute inset-[-59.31%_-33.58%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 1364 1010">
            <g filter="url(#filter0_f_461_12744)" id="Ellipse 44">
              <ellipse cx="682" cy="505" fill="var(--fill-0, #0F62FE)" rx="408" ry="231" />
            </g>
            <defs>
              <filter colorInterpolationFilters="sRGB" filterUnits="userSpaceOnUse" height="1010" id="filter0_f_461_12744" width="1364" x="0" y="0">
                <feFlood floodOpacity="0" result="BackgroundImageFix" />
                <feBlend in="SourceGraphic" in2="BackgroundImageFix" mode="normal" result="shape" />
                <feGaussianBlur result="effect1_foregroundBlur_461_12744" stdDeviation="137" />
              </filter>
            </defs>
          </svg>
        </div>
      ...
      <p className="absolute font-['IBM_Plex_Sans:Bold',sans-serif] leading-[32px] left-[24px] not-italic text-[28px] text-white top-[88px] tracking-[0.16px] w-[289px] whitespace-pre-wrap">87% сотрудников читают новости</p>
      <Pagination />
      <Button20 />
      <Button21 />
      <NewsList />
      <ActionList />
      <p className="absolute font-['IBM_Plex_Sans:Regular',sans-serif] leading-[22px] left-[24px] not-italic text-[16px] text-white top-[172px] w-[253px] whitespace-pre-wrap">Не посмотрели важные новости</p>
      <p className="absolute font-['IBM_Plex_Sans:Regular',sans-serif] leading-[22px] left-[24px] not-italic text-[16px] text-white top-[555px]">Не сделали обязательное действие</p>
    </div>
  );
}
...
export default function Component() {
  return (
    <div className="bg-[#f2f4f8] relative size-full" data-name="Лента новостей">
      ...
      <Component1 />
      <div className="absolute bg-[#393939] content-stretch flex flex-col items-center justify-center left-[calc(31.25%+22.5px)] overflow-clip rounded-[50px] size-[48px] top-[468px]" data-name="Button">
        <ButtonContent6 />
      </div>
    </div>
  );
