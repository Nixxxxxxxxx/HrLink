import svgPaths from "./svg-uh6i2nh6up";
...
function ArticleContent3() {
  return (
    <div className="content-stretch flex flex-col gap-[12px] items-start relative shrink-0 w-full whitespace-pre-wrap" data-name="Article content">
      <p className="font-['Montserrat:SemiBold',sans-serif] font-semibold leading-[24px] max-w-[334px] relative shrink-0 text-[#161616] text-[18px] w-full">Развитие цифровых инструментов прогнозирования</p>
      <p className="font-['IBM_Plex_Sans:Regular',sans-serif] leading-[0] max-w-[334px] not-italic relative shrink-0 text-[#171a1c] text-[0px] text-[14px] tracking-[0.16px] w-full">
        <span className="leading-[20px]">{`Компания расширила применение технологий машинног�� обучения для анализа состояния оборудования. `}</span>
        <span className="[text-decoration-skip-ink:none] decoration-solid leading-[20px] text-[#054ada] underline">Проект</span>
        <span className="leading-[20px]">{` реализуется в рамках программы цифровой трансформации производственных процессов.`}</span>
      </p>
    </div>
        ...
        <div className="absolute bottom-0 right-0 top-0 w-[20px]" data-name="🎨 Color l Thumb">
          <div className="absolute inset-[-5%]">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 22 22">
              <g filter="url(#filter0_d_461_12892)" id="ð¨ Color l Thumb">
                <path clipRule="evenodd" d={svgPaths.pb60700} fill="var(--fill-0, #054ADA)" fillRule="evenodd" />
              </g>
              <defs>
                <filter colorInterpolationFilters="sRGB" filterUnits="userSpaceOnUse" height="22" id="filter0_d_461_12892" width="22" x="0" y="0">
                  ...
                  <feBlend in2="BackgroundImageFix" mode="normal" result="effect1_dropShadow_461_12892" />
                  <feBlend in="SourceGraphic" in2="effect1_dropShadow_461_12892" mode="normal" result="shape" />
                </filter>
              </defs>
            </svg>
          </div>
      ...
      <div className="overflow-clip relative shrink-0 size-[20px]" data-name="Radio-button--checked">
        ...
        <div className="absolute inset-[6.25%]" data-name="Vector">
          <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 17.5 17.5">
            <g id="Vector">
              <path d={svgPaths.p3d52b680} fill="white" />
              <path d={svgPaths.p91fdd00} fill="white" />
            </g>
          </svg>
        </div>
      </div>
...
function ActionList() {
  return (
    <div className="absolute bg-[rgba(171,192,255,0.1)] content-stretch flex gap-[12px] items-center left-[24px] px-[16px] py-[12px] rounded-[12px] top-[188px] w-[439px]" data-name="Action list">
...
function NewsItem() {
  return (
    <div className="absolute bg-[rgba(171,192,255,0.1)] content-stretch flex gap-[12px] items-center left-[24px] px-[16px] py-[12px] rounded-[12px] top-[286px] w-[439px]" data-name="News Item">
      <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0" data-name="Radio button">
        <div aria-hidden="true" className="absolute bg-[rgba(255,255,255,0)] inset-0 mix-blend-multiply pointer-events-none" />
        <IconValueAiSlug1 />
      </div>
...
function NewsItem1() {
  return (
    <div className="absolute bg-[rgba(171,192,255,0.1)] content-stretch flex gap-[12px] items-center left-[24px] px-[16px] py-[12px] rounded-[12px] top-[362px] w-[439px]" data-name="News Item">
      <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0" data-name="Radio button">
        <div aria-hidden="true" className="absolute bg-[rgba(255,255,255,0)] inset-0 mix-blend-multiply pointer-events-none" />
        <IconValueAiSlug2 />
      </div>
...
function NewsItem2() {
  return (
    <div className="absolute bg-[rgba(171,192,255,0.1)] content-stretch flex gap-[12px] items-center left-[24px] px-[16px] py-[12px] rounded-[12px] top-[438px] w-[439px]" data-name="News Item">
      <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0" data-name="Radio button">
        <div aria-hidden="true" className="absolute bg-[rgba(255,255,255,0)] inset-0 mix-blend-multiply pointer-events-none" />
        <IconValueAiSlug3 />
      </div>
...
function Component1() {
  return (
    <div className="absolute bg-[#1b1f29] h-[853px] left-[calc(37.5%-8px)] overflow-clip rounded-[12px] top-[65px] w-[487px]" data-name="Сотрудник">
      <div className="absolute h-[462px] left-[-208px] top-[717px] w-[816px]">
        <div className="absolute inset-[-59.31%_-33.58%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 1364 1010">
            <g filter="url(#filter0_f_461_12858)" id="Ellipse 44">
              <ellipse cx="682" cy="505" fill="var(--fill-0, #0F62FE)" rx="408" ry="231" />
            </g>
            <defs>
              <filter colorInterpolationFilters="sRGB" filterUnits="userSpaceOnUse" height="1010" id="filter0_f_461_12858" width="1364" x="0" y="0">
                <feFlood floodOpacity="0" result="BackgroundImageFix" />
                <feBlend in="SourceGraphic" in2="BackgroundImageFix" mode="normal" result="shape" />
                <feGaussianBlur result="effect1_foregroundBlur_461_12858" stdDeviation="137" />
              </filter>
            </defs>
          </svg>
        </div>
      ...
      <Button20 />
      <Button21 />
      <p className="absolute font-['IBM_Plex_Sans:Regular',sans-serif] leading-[22px] left-[24px] not-italic text-[16px] text-white top-[132px] w-[294px] whitespace-pre-wrap">Как вы думаете, какая новость самая обсуждаемая среди коллег?</p>
      <ActionList />
      <NewsItem />
      <NewsItem1 />
      <NewsItem2 />
