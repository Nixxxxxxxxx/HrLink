import svgPaths from "./svg-cuihelj6hn";
...
function NewsItem() {
  return (
    <div className="absolute bg-[rgba(171,192,255,0.1)] content-stretch flex gap-[12px] items-center left-[24px] px-[16px] py-[12px] rounded-[12px] top-[290px] w-[439px]" data-name="News Item">
...
function NewsContainer() {
  return (
    <div className="absolute bg-[rgba(171,192,255,0.1)] content-stretch flex gap-[12px] items-center left-[24px] px-[16px] py-[12px] rounded-[12px] top-[192px] w-[439px]" data-name="News Container">
      <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0" data-name="Radio button">
        <div aria-hidden="true" className="absolute bg-[rgba(255,255,255,0)] inset-0 mix-blend-multiply pointer-events-none" />
        <IconValueAiSlug1 />
      </div>
      <p className="flex-[1_0_0] font-['IBM_Plex_Sans:Regular',sans-serif] h-full leading-[22px] min-h-px min-w-px not-italic relative text-[16px] text-white whitespace-pre-wrap">
        {`ПромИнвест объявляет о внедрении цифровых двойников `}
        <br aria-hidden="true" />в производственные процессы.
      </p>
    </div>
  );
}
...
function NewsItem1() {
  return (
    <div className="absolute bg-[rgba(171,255,182,0.1)] content-stretch flex gap-[12px] items-center left-[24px] px-[16px] py-[12px] rounded-[12px] top-[366px] w-[439px]" data-name="News Item">
...
function NewsItem2() {
  return (
    <div className="absolute bg-[rgba(171,192,255,0.1)] content-stretch flex gap-[12px] items-center left-[24px] px-[16px] py-[12px] rounded-[12px] top-[442px] w-[439px]" data-name="News Item">
      <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0" data-name="Radio button">
        <div aria-hidden="true" className="absolute bg-[rgba(255,255,255,0)] inset-0 mix-blend-multiply pointer-events-none" />
        <IconValueAiSlug2 />
      </div>
...
function Component1() {
  return (
    <div className="absolute bg-[#1b1f29] h-[853px] left-[calc(37.5%-8px)] overflow-clip rounded-[12px] top-[65px] w-[487px]" data-name="Сотрудник">
      ...
      <p className="-translate-x-1/2 absolute font-['IBM_Plex_Sans:Regular',sans-serif] leading-[22px] left-[calc(50%-0.5px)] not-italic text-[16px] text-center text-white top-[522px] w-[342px] whitespace-pre-wrap">46% сотрудников отметили эту новость как самую обсуждаемую за неделю</p>
      <NewsItem />
      <NewsContainer />
      <NewsItem1 />
      <NewsItem2 />
