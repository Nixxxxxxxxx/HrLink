import svgPaths from "./svg-87gufa0mq1";
    ...
    <div className="-translate-x-1/2 absolute h-[8px] left-[calc(50%-0.5px)] top-[821px] w-[88px]" data-name="Pagination">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 88 8">
        <g id="Pagination">
          ...
          <circle cx="44" cy="4" fill="var(--fill-0, white)" id="Ellipse 38" r="4" />
      ...
      <div className="overflow-clip relative shrink-0 size-[20px]" data-name="Radio-button">
        ...
        <div className="absolute inset-[6.25%]" data-name="Vector">
          <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 17.5 17.5">
            <path d={svgPaths.p2e910480} fill="var(--fill-0, white)" id="Vector" />
          </svg>
        </div>
      </div>
    </div>
...
function NewsItem() {
  return (
    <div className="absolute bg-[rgba(171,192,255,0.1)] content-stretch flex gap-[12px] items-center left-[24px] px-[16px] py-[12px] rounded-[12px] top-[268px] w-[439px]" data-name="News Item">
      <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0" data-name="Radio button">
        <div aria-hidden="true" className="absolute bg-[rgba(255,255,255,0)] inset-0 mix-blend-multiply pointer-events-none" />
        <IconValueAiSlug />
      </div>
      <p className="flex-[1_0_0] font-['IBM_Plex_Sans:Regular',sans-serif] h-full leading-[22px] min-h-px min-w-px not-italic relative text-[16px] text-white whitespace-pre-wrap">Компания представила новую платформу для анализа производительности.</p>
    </div>
  );
}
...
function NewsItem1() {
  return (
    <div className="absolute bg-[rgba(171,255,182,0.1)] content-stretch flex gap-[12px] items-center left-[24px] px-[16px] py-[12px] rounded-[12px] top-[344px] w-[439px]" data-name="News Item">
      <div className="overflow-clip relative shrink-0 size-[20px]" data-name="Checkmark">
        <div aria-hidden="true" className="absolute bg-[rgba(255,255,255,0)] inset-0 mix-blend-multiply pointer-events-none" />
        <div className="absolute inset-[6.25%]" data-name="Vector">
          <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 17.5 17.5">
            <g id="Vector">
              <path d={svgPaths.pe56400} fill="#26FF12" />
              <path d={svgPaths.p3d52b680} fill="#26FF12" />
            </g>
          </svg>
        </div>
      </div>
      <p className="flex-[1_0_0] font-['IBM_Plex_Sans:Regular',sans-serif] h-full leading-[22px] min-h-px min-w-px not-italic relative text-[16px] text-white whitespace-pre-wrap">Запущен проект по автоматизации контроля качества продукции.</p>
    </div>
  );
}
...
function NewsItem2() {
  return (
    <div className="absolute bg-[rgba(171,192,255,0.1)] content-stretch flex gap-[12px] items-center left-[24px] px-[16px] py-[12px] rounded-[12px] top-[420px] w-[439px]" data-name="News Item">
      <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0" data-name="Radio button">
        <div aria-hidden="true" className="absolute bg-[rgba(255,255,255,0)] inset-0 mix-blend-multiply pointer-events-none" />
        <IconValueAiSlug1 />
      </div>
      <p className="flex-[1_0_0] font-['IBM_Plex_Sans:Regular',sans-serif] h-full leading-[22px] min-h-px min-w-px not-italic relative text-[16px] text-white whitespace-pre-wrap">ПромИнвест усиливает сотрудничество с университетами в области новых технологий.</p>
    </div>
  );
}
...
function Frame9() {
  return (
    <div className="content-stretch flex items-center justify-center relative rounded-[100px] shrink-0 size-[20px]">
      <div aria-hidden="true" className="absolute border border-[#fa151f] border-solid inset-0 pointer-events-none rounded-[100px]" />
      <div className="overflow-clip relative shrink-0 size-[16px]" data-name="Close">
        <div aria-hidden="true" className="absolute bg-[rgba(255,255,255,0)] inset-0 mix-blend-multiply pointer-events-none" />
        <div className="absolute inset-1/4" data-name="Vector">
          <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 8 8">
            <path d={svgPaths.p314604c0} fill="var(--fill-0, #FA151F)" id="Vector" />
          </svg>
        </div>
      </div>
    </div>
...
function NewsItem3() {
  return (
    <div className="absolute bg-[rgba(255,171,171,0.1)] content-stretch flex gap-[12px] items-center left-[24px] px-[16px] py-[12px] rounded-[12px] top-[192px] w-[439px]" data-name="News item">
      <Frame9 />
      <p className="flex-[1_0_0] font-['IBM_Plex_Sans:Regular',sans-serif] h-full leading-[22px] min-h-px min-w-px not-italic relative text-[16px] text-white whitespace-pre-wrap">ПромИнвест объявляет о внедрении цифровых двойников в производственные процессы.</p>
    </div>
  );
}
...
function Component1() {
  return (
    <div className="absolute bg-[#1b1f29] h-[853px] left-[calc(37.5%-8px)] overflow-clip rounded-[12px] top-[65px] w-[487px]" data-name="Сотрудник">
      ...
      <p className="absolute font-['IBM_Plex_Sans:Bold',sans-serif] leading-[32px] left-[24px] not-italic text-[28px] text-white top-[88px] tracking-[0.16px]">Проверьте интуицию</p>
      <Pagination />
      <Button20 />
      <Button21 />
      <p className="absolute font-['IBM_Plex_Sans:Regular',sans-serif] leading-[22px] left-[24px] not-italic text-[16px] text-white top-[132px] w-[325px] whitespace-pre-wrap">Как вы думаете, какая новость самая обсуждаемая среди коллег?</p>
      <p className="-translate-x-1/2 absolute font-['IBM_Plex_Sans:Regular',sans-serif] leading-[22px] left-1/2 not-italic text-[16px] text-center text-white top-[500px] w-[439px] whitespace-pre-wrap">
        {`23 сотрудника выбрали этот вариант за неделю. `}
        <br aria-hidden="true" />
        Самая популярная новость — “Запущен проект по автоматиза..”
      </p>
      <NewsItem />
      <NewsItem1 />
      <NewsItem2 />
