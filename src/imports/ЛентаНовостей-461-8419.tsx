import svgPaths from "./svg-3iu91mvh7n";
        ...
        <div className="absolute bottom-0 right-0 top-0 w-[20px]" data-name="🎨 Color l Thumb">
          <div className="absolute inset-[-5%]">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 22 22">
              <g filter="url(#filter0_d_461_13015)" id="ð¨ Color l Thumb">
                <path clipRule="evenodd" d={svgPaths.pb60700} fill="var(--fill-0, #054ADA)" fillRule="evenodd" />
              </g>
              <defs>
                <filter colorInterpolationFilters="sRGB" filterUnits="userSpaceOnUse" height="22" id="filter0_d_461_13015" width="22" x="0" y="0">
                  ...
                  <feBlend in2="BackgroundImageFix" mode="normal" result="effect1_dropShadow_461_13015" />
                  <feBlend in="SourceGraphic" in2="effect1_dropShadow_461_13015" mode="normal" result="shape" />
                </filter>
              </defs>
            </svg>
          </div>
    ...
    <div className="-translate-x-1/2 absolute h-[8px] left-[calc(50%-0.5px)] top-[821px] w-[88px]" data-name="Pagination">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 88 8">
        <g id="Pagination">
          ...
          <circle cx="24" cy="4" fill="var(--fill-0, #E3E5E8)" fillOpacity="0.3" id="Ellipse 41" r="4" />
          <circle cx="44" cy="4" fill="var(--fill-0, #E3E5E8)" fillOpacity="0.3" id="Ellipse 42" r="4" />
          <circle cx="64" cy="4" fill="var(--fill-0, white)" id="Ellipse 38" r="4" />
...
function Button22() {
  return (
    <div className="bg-[rgba(255,255,255,0.2)] content-stretch flex gap-[5px] h-[26px] items-center pl-[6px] pr-[9px] relative rounded-[50px] shrink-0" data-name="Button">
      <p className="relative shrink-0 text-[transparent]">❤️</p>
      <p className="relative shrink-0 text-white">45</p>
    </div>
  );
}
...
function Button23() {
  return (
    <div className="bg-[rgba(255,255,255,0.2)] content-stretch flex gap-[5px] h-[26px] items-center pl-[6px] pr-[9px] relative rounded-[50px] shrink-0" data-name="Button">
      <p className="relative shrink-0 text-[transparent]">🔥</p>
...
function Button24() {
  return (
    <div className="bg-[rgba(255,255,255,0.2)] content-stretch flex gap-[5px] h-[26px] items-center pl-[6px] pr-[9px] relative rounded-[50px] shrink-0" data-name="Button">
      <p className="relative shrink-0 text-[transparent]">👍</p>
      <p className="relative shrink-0 text-white">12</p>
    </div>
  );
}
...
function Reactions5() {
  return (
    <div className="content-stretch flex gap-[8px] items-center relative shrink-0" data-name="Reactions">
      <Button22 />
      <Button23 />
      <Button24 />
    </div>
...
function PostReactions() {
  return (
    <div className="content-stretch flex gap-[12px] items-center leading-[20px] relative shrink-0" data-name="Post reactions">
      <Reactions5 />
      <p className="relative shrink-0 text-[rgba(255,255,255,0.6)] tracking-[0.16px]">12 комментариев</p>
    </div>
  );
}
...
function Post1() {
  return (
    <div className="bg-[rgba(171,192,255,0.1)] relative rounded-[12px] shrink-0 w-full" data-name="Post">
      <div className="content-stretch flex flex-col font-['IBM_Plex_Sans:Regular',sans-serif] gap-[16px] items-start not-italic pb-[16px] pt-[12px] px-[16px] relative text-[14px] w-full">
        <p className="leading-[0] min-w-full relative shrink-0 text-white w-[min-content] whitespace-pre-wrap">
          <span className="leading-[20px]">{`В дизайн-команде `}</span>
          <span className="[text-decoration-skip-ink:none] decoration-solid leading-[20px] text-[#78a9ff] underline">запущен</span>
          <span className="leading-[20px]">{` пилотный проект по использованию ИИ в создании макетов.`}</span>
        </p>
        <PostReactions />
      </div>
    </div>
...
function Button25() {
  return (
    <div className="bg-[rgba(255,255,255,0.2)] content-stretch flex gap-[5px] h-[26px] items-center pl-[6px] pr-[9px] relative rounded-[50px] shrink-0" data-name="Button">
      <p className="relative shrink-0 text-[transparent]">👍</p>
      <p className="relative shrink-0 text-white">66</p>
    </div>
  );
}
...
function Button26() {
  return (
    <div className="bg-[rgba(255,255,255,0.2)] content-stretch flex gap-[5px] h-[26px] items-center pl-[6px] pr-[9px] relative rounded-[50px] shrink-0" data-name="Button">
      <p className="relative shrink-0 text-[transparent]">🔥</p>
      <p className="relative shrink-0 text-white">15</p>
    </div>
  );
}
...
function PostReactions1() {
  return (
    <div className="content-stretch flex gap-[12px] items-center leading-[20px] relative shrink-0" data-name="Post reactions">
      <Reactions6 />
      <p className="relative shrink-0 text-[rgba(255,255,255,0.6)] tracking-[0.16px]">9 комментариев</p>
    </div>
  );
}
...
function Post2() {
  return (
    <div className="bg-[rgba(171,192,255,0.1)] relative rounded-[12px] shrink-0 w-full" data-name="Post">
      <div className="content-stretch flex flex-col font-['IBM_Plex_Sans:Regular',sans-serif] gap-[16px] items-start not-italic pb-[16px] pt-[12px] px-[16px] relative text-[14px] w-full">
        <p className="leading-[0] relative shrink-0 text-white w-[316px] whitespace-pre-wrap">
          <span className="leading-[20px]">{`Команда дизайна Северстали `}</span>
          <span className="[text-decoration-skip-ink:none] decoration-solid leading-[20px] text-[#78a9ff] underline">представила</span>
          <span className="leading-[20px]">{` новый брендбук компании.`}</span>
        </p>
        <PostReactions1 />
      </div>
    </div>
...
function Button27() {
  return (
    <div className="bg-[rgba(255,255,255,0.2)] content-stretch flex font-['IBM_Plex_Sans:Regular',sans-serif] gap-[5px] h-[26px] items-center leading-[20px] not-italic pl-[6px] pr-[9px] relative rounded-[50px] shrink-0 text-[14px]" data-name="Button">
      <p className="relative shrink-0 text-[transparent]">❤️</p>
      <p className="relative shrink-0 text-white">50</p>
    </div>
  );
}
...
function Reactions7() {
  return (
    <div className="content-stretch flex items-center relative shrink-0" data-name="Reactions">
      <Button27 />
    </div>
  );
}

function PostReactions2() {
  return (
    <div className="content-stretch flex gap-[12px] items-center relative shrink-0" data-name="Post reactions">
      <Reactions7 />
      <p className="font-['IBM_Plex_Sans:Regular',sans-serif] leading-[20px] not-italic relative shrink-0 text-[14px] text-[rgba(255,255,255,0.6)] tracking-[0.16px]">18 комментариев</p>
    </div>
  );
}
  ...
  return (
    <div className="bg-[rgba(171,192,255,0.1)] relative rounded-[12px] shrink-0 w-full" data-name="Post">
      <div className="content-stretch flex flex-col gap-[16px] items-start pb-[16px] pt-[12px] px-[16px] relative w-full">
        <p className="font-['IBM_Plex_Sans:Regular',sans-serif] leading-[0] not-italic relative shrink-0 text-[14px] text-white w-[342px] whitespace-pre-wrap">
          <span className="leading-[20px]">{`Дизайнеры Северстали `}</span>
          <span className="[text-decoration-skip-ink:none] decoration-solid leading-[20px] text-[#78a9ff] underline">выиграли</span>
          <span className="leading-[20px]">{` престижную премию за лучший UX/UI дизайн приложения.`}</span>
        </p>
        <PostReactions2 />
      </div>
    </div>
...
function Post() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[8px] items-start left-[24px] top-[224px] w-[439px]" data-name="Post">
      <Post1 />
      <Post2 />
      <Post3 />
    </div>
...
function Component1() {
  return (
    <div className="absolute bg-[#1b1f29] h-[853px] left-[calc(37.5%-8px)] overflow-clip rounded-[12px] top-[65px] w-[487px]" data-name="Сотрудник">
      <div className="absolute h-[462px] left-[-208px] top-[717px] w-[816px]">
        <div className="absolute inset-[-59.31%_-33.58%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 1364 1010">
            <g filter="url(#filter0_f_461_12976)" id="Ellipse 44">
              <ellipse cx="682" cy="505" fill="var(--fill-0, #0F62FE)" rx="408" ry="231" />
            </g>
            <defs>
              <filter colorInterpolationFilters="sRGB" filterUnits="userSpaceOnUse" height="1010" id="filter0_f_461_12976" width="1364" x="0" y="0">
                <feFlood floodOpacity="0" result="BackgroundImageFix" />
                <feBlend in="SourceGraphic" in2="BackgroundImageFix" mode="normal" result="shape" />
                <feGaussianBlur result="effect1_foregroundBlur_461_12976" stdDeviation="137" />
              </filter>
            </defs>
          </svg>
        </div>
      ...
      <p className="absolute font-['IBM_Plex_Sans:Bold',sans-serif] leading-[32px] left-[24px] not-italic text-[28px] text-white top-[88px] tracking-[0.16px]">
        {`Самое обсуждаемое `}
        <br aria-hidden="true" />
        за неделю
      </p>
      ...
      <Button20 />
      <Button21 />
      <div className="absolute font-['IBM_Plex_Sans:Regular',sans-serif] leading-[22px] left-[24px] not-italic text-[16px] text-white top-[164px] w-[325px] whitespace-pre-wrap">
        <p className="mb-0">А всего за неделю:</p>
        <p>40 комментариев и 20 реакций</p>
      </div>
      <Post />
    </div>
  );
