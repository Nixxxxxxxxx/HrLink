import svgPaths from "./svg-4qhd7awcrd";
    ...
    <div className="-translate-x-1/2 absolute h-[8px] left-[calc(50%-0.5px)] top-[821px] w-[88px]" data-name="Pagination">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 88 8">
        <g id="Pagination">
          ...
          <circle cx="64" cy="4" fill="var(--fill-0, #E3E5E8)" fillOpacity="0.3" id="Ellipse 40" r="4" />
          <circle cx="84" cy="4" fill="var(--fill-0, white)" id="Ellipse 38" r="4" />
        </g>
      </svg>
    </div>
  );
    ...
    <div className="relative shrink-0 w-full" data-name="Button content">
      <div className="flex flex-row items-end justify-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex isolate items-end justify-center px-[16px] py-[11px] relative w-full">
          <p className="font-['IBM_Plex_Sans:Regular',sans-serif] leading-[18px] not-italic relative shrink-0 text-[14px] text-white tracking-[0.16px] z-[2]">Завершить</p>
        </div>
      </div>
    </div>
  );
...
function Component1() {
  return (
    <div className="absolute bg-[#1b1f29] h-[853px] left-[calc(37.5%-8px)] overflow-clip rounded-[12px] top-[65px] w-[487px]" data-name="Сотрудник">
      ...
      <p className="absolute font-['IBM_Plex_Sans:Bold',sans-serif] leading-[32px] left-[24px] not-italic text-[28px] text-white top-[88px] tracking-[0.16px] w-[339px] whitespace-pre-wrap">
        {`До встречи `}
        <br aria-hidden="true" />
        на следующей неделе
      </p>
      ...
      <Button20 />
      <Button21 />
      <p className="absolute font-['IBM_Plex_Sans:Regular',sans-serif] leading-[22px] left-[24px] not-italic text-[16px] text-white top-[164px] w-[325px] whitespace-pre-wrap">
        {`Соберём для вас главные по компании `}
        <br aria-hidden="true" />и важные новости. Загляните, чтобы ничего не пропустить.
      </p>
      <div className="-translate-x-1/2 absolute bg-[#0f62fe] content-stretch flex flex-col items-center justify-center left-1/2 overflow-clip top-[242px] w-[439px]" data-name="Button">
        <ButtonContent6 />
      </div>
    </div>
  );
