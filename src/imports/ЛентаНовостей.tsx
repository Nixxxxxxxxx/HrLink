import svgPaths from "./svg-4tmcsipoal";
import imgChannelItemAvatar from "figma:asset/a0ace302815355598c9cc0e76105481bcae5d435.png";
...
import imgNewsItemDescriptionIcon1 from "figma:asset/ba4dc61507a77d1a33d17c6dfbc92f1fe324f957.png";
import imgChannelItemAvatar2 from "figma:asset/5c134ebbd02006bf49c42198e659562a3a0ac036.png";
import imgNewsItemDescriptionIcon2 from "figma:asset/c936e8b3093b9815209e2159c3ae99e5a8e4a187.png";
import imgNewsItemDescriptionIcon3 from "figma:asset/e1c4d5265c5a16b5508c9bcbcd71a4ece85b2308.png";
...
function ChannelItemAvatar1() {
  return (
    <div className="relative rounded-[100px] shrink-0 size-[58px]" data-name="channel_item_avatar">
      <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none rounded-[100px] size-full" src={imgChannelItemAvatar} />
    </div>
  );
}
  ...
  return (
    <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid items-[start] justify-items-[start] leading-[0] relative shrink-0" data-name="News item description wrapper">
      ...
      <div className="col-1 h-[14px] ml-0 mt-[2px] relative rounded-[2px] row-1 w-[15px]" data-name="News item description icon">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none rounded-[2px] size-full" src={imgNewsItemDescriptionIcon3} />
      </div>
    </div>
  );
}
...
function Img() {
  return (
    <div className="h-[106px] relative shrink-0 w-full" data-name="Img">
      <div className="-translate-x-1/2 -translate-y-1/2 absolute flex h-[86.297px] items-center justify-center left-[calc(50%-38.36px)] top-[calc(50%-3.39px)] w-[110.537px]" style={{ "--transform-inner-width": "1200", "--transform-inner-height": "19" } as React.CSSProperties}>
      ...
      <div className="-translate-x-1/2 -translate-y-1/2 absolute flex h-[67.728px] items-center justify-center left-[calc(50%+41px)] top-[calc(50%+2.45px)] w-[85.257px]" style={{ "--transform-inner-width": "1200", "--transform-inner-height": "19" } as React.CSSProperties}>
        <div className="flex-none rotate-[15.79deg]">
          <div className="h-[49.265px] relative rounded-[10px] w-[74.667px]">
            <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none rounded-[10px] size-full" src={imgChannelItemAvatar} />
          </div>
        </div>
      </div>
    </div>
...
function HrlinkLogo() {
  return (
    <div className="absolute inset-[0.26%_0_2%_0.05%]" data-name="hrlink_logo">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 62.0843 23.4595">
        <g id="hrlink_logo">
