import svgPaths from "./svg-rhahmj2h1i";
...
function Frame34() {
  return (
    <div className="h-[64px] relative shrink-0 w-[90px]">
      <div className="-translate-x-1/2 -translate-y-1/2 absolute flex h-[54.413px] items-center justify-center left-[calc(50%-9.27px)] top-[calc(50%-4.79px)] w-[69.697px]" style={{ "--transform-inner-width": "1200", "--transform-inner-height": "18.875" } as React.CSSProperties}>
      ...
      <div className="-translate-x-1/2 -translate-y-1/2 absolute flex h-[42.705px] items-center justify-center left-[calc(50%+17.24px)] top-[calc(50%+13.07px)] w-[53.758px]" style={{ "--transform-inner-width": "1200", "--transform-inner-height": "18.875" } as React.CSSProperties}>
