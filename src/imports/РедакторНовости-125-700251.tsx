import svgPaths from "./svg-e24h5z5syj";
    ...
    <div className="relative shrink-0 size-[20px]" data-name="Font">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="Font">
          ...
          <g id="Vector">
            <path d={svgPaths.p3e5c4c00} fill="#525252" />
            <path d={svgPaths.p20af4b00} fill="#525252" />
          </g>
        </g>
      </svg>
    </div>
  ...
  return (
    <div className="relative shrink-0 size-[20px]" data-name="Bold">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="Bold">
          <rect fill="white" fillOpacity="0.01" height="20" style={{ mixBlendMode: "multiply" }} width="20" />
          <path d={svgPaths.pef1c480} fill="var(--fill-0, #525252)" id="Vector" />
        </g>
      </svg>
    </div>
  );
  ...
  return (
    <div className="relative shrink-0 size-[20px]" data-name="Italic">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="Italic">
          <rect fill="white" fillOpacity="0.01" height="20" style={{ mixBlendMode: "multiply" }} width="20" />
          <path d={svgPaths.p54b4180} fill="var(--fill-0, #525252)" id="Vector" />
        </g>
      </svg>
    </div>
  );
    ...
    <div className="relative shrink-0 size-[20px]" data-name="Underline">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="Underline">
          <rect fill="white" fillOpacity="0.01" height="20" style={{ mixBlendMode: "multiply" }} width="20" />
          <g id="Vector">
            <path d={svgPaths.p3b97ed00} fill="#525252" />
            <path d={svgPaths.p65a6000} fill="#525252" />
          </g>
        </g>
      </svg>
    </div>
    ...
    <div className="relative shrink-0 size-[20px]" data-name="Numbered List">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="Numbered List">
          <rect fill="white" fillOpacity="0.01" height="20" style={{ mixBlendMode: "multiply" }} width="20" />
          <g id="Vector">
            <path d={svgPaths.pce76e00} fill="var(--fill-0, #525252)" />
            <path d="M10 13.75H1.25V15H10V13.75Z" fill="var(--fill-0, #525252)" />
            <path d={svgPaths.p3f3dac00} fill="var(--fill-0, #525252)" />
            <path d="M10 5H1.25V6.25H10V5Z" fill="var(--fill-0, #525252)" />
          </g>
        </g>
      </svg>
    </div>
    ...
    <div className="relative shrink-0 size-[20px]" data-name="List">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="List">
          <rect fill="white" fillOpacity="0.01" height="20" style={{ mixBlendMode: "multiply" }} width="20" />
          <g id="Vector">
            <path d="M17.5 3.75H6.25V5H17.5V3.75Z" fill="#525252" />
            <path d="M17.5 15H6.25V16.25H17.5V15Z" fill="#525252" />
            <path d={svgPaths.p1472e8f0} fill="#525252" />
            <path d={svgPaths.pfb58eb0} fill="#525252" />
            <path d="M3.75 3.75H2.5V5H3.75V3.75Z" fill="#525252" />
            <path d="M3.75 15H2.5V16.25H3.75V15Z" fill="#525252" />
          </g>
        </g>
      </svg>
    </div>
