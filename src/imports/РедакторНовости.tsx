import svgPaths from "./svg-ihi1250utl";
...
function Frame16() {
  return (
    <div className="absolute bg-[rgba(255,255,255,0.2)] bottom-[8px] content-stretch flex items-center justify-center left-[8px] pb-[3px] px-[6px] rounded-[40px]">
...
function Frame37() {
  return (
    <div className="content-stretch flex flex-col gap-[24px] items-start max-w-[464px] not-italic relative shrink-0 text-[#161616] w-full">
      <Frame36 />
      <Frame35 />
    </div>
  );
...
function Frame38() {
  return (
    <div className="absolute bg-white content-stretch flex flex-col gap-[24px] items-start left-[348px] pb-[32px] pt-[16px] px-[16px] top-[226px] w-[520px]">
      <Frame34 />
      <Frame10 />
      <Frame37 />
    </div>
  ...
  return (
    <div className="relative shrink-0 w-full" data-name="Button content">
      <div className="flex flex-row items-center justify-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex isolate items-center justify-center p-[8px] relative w-full">
          <Icon />
        </div>
      </div>
    </div>
...
function Button() {
  return (
    <div className="content-stretch flex flex-col items-center justify-center overflow-clip relative shrink-0 size-[32px]" data-name="Button">
      <div aria-hidden="true" className="absolute bg-[rgba(255,255,255,0)] inset-0 mix-blend-multiply pointer-events-none" />
      <ButtonContent />
    </div>
  );
...
function Label() {
  return (
    <div className="content-stretch flex flex-col items-center mr-[-4px] pb-[2px] px-[8px] relative shrink-0" data-name="Label">
      <p className="font-['IBM_Plex_Sans:Regular',sans-serif] leading-[16px] not-italic relative shrink-0 text-[#161616] text-[12px] tracking-[0.32px]">Черновик</p>
      <Resizer />
    </div>
  );
}
...
function TagReadOnly() {
  return (
    <div className="bg-white content-stretch flex items-start pr-[6px] relative rounded-[12px] shrink-0" data-name="Tag - Read-only">
      <div aria-hidden="true" className="absolute border border-[#161616] border-solid inset-0 pointer-events-none rounded-[12px]" />
      <TagContent />
    </div>
  );
}
...
function Frame39() {
  return (
    <div className="content-stretch flex gap-[15px] items-center relative shrink-0">
      <Button />
      <p className="font-['Montserrat:SemiBold',sans-serif] leading-[26px] not-italic relative shrink-0 text-[20px] text-black">Создать новость</p>
      <TagReadOnly />
    </div>
  );
}
...
function Frame22() {
  return (
    <div className="absolute bg-white content-stretch flex items-center justify-between left-[96px] px-[16px] py-[14px] top-[62px] w-[1416px]">
      ...
      <div className="absolute inset-[-5%_-2.78%_-5%_0]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 37 22">
          <g id="Switch">
            ...
            <g filter="url(#filter0_d_65_40007)" id="ð¨ Color l Thumb">
              <path clipRule="evenodd" d={svgPaths.p1fd353c0} fill="var(--fill-0, #054ADA)" fillRule="evenodd" />
            </g>
          </g>
          <defs>
            <filter colorInterpolationFilters="sRGB" filterUnits="userSpaceOnUse" height="22" id="filter0_d_65_40007" width="22" x="15" y="0">
              ...
              <feBlend in2="BackgroundImageFix" mode="normal" result="effect1_dropShadow_65_40007" />
              <feBlend in="SourceGraphic" in2="effect1_dropShadow_65_40007" mode="normal" result="shape" />
            </filter>
          </defs>
        </svg>
      </div>
...
function Switch1() {
  return <div className="bg-white rounded-[100px] shrink-0 size-[18px]" data-name="Switch" />;
}

function ToggleItem() {
  return (
    <div className="bg-[#8d8d8d] content-stretch flex items-start overflow-clip p-[3px] relative rounded-[12px] shrink-0 w-[48px]" data-name="_Toggle item">
      <Switch1 />
    </div>
  );
}
...
function Frame30() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-start relative shrink-0 w-[275px]">
      <Toggle />
      <Toggle1 />
      <Toggle2 />
      <Toggle3 />
...
function Frame41() {
  return (
    <div className="absolute bg-white content-stretch flex flex-col gap-[16px] h-[852px] items-start left-[1096px] px-[24px] py-[32px] top-[130px] w-[416px]">
      <Frame32 />
      <Accordion />
    </div>
  );
...
function Frame11() {
  return (
    <div className="absolute bg-white left-[108px] rounded-[8px] top-[142px] w-[976px]">
...
export default function Component() {
  return (
    <div className="bg-[#f2f4f8] relative size-full" data-name="Редактор новости">
      <div className="absolute h-[852px] left-[96px] top-[130px] w-[1344px]">
